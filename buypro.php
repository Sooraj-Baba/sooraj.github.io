    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?php
                ...
                $FindItemId = "SELECT * FROM products WHERE id={$itemid}";
                ...
                $check = mysqli_num_rows($ques);
                   ...
                   if($check == true){
                       ...
                       while( $getproduct = mysqli_fetch_array($ques)){
                    ...
                    <div class="card m-auto">
                        <table class="table table-responsive border">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $getproduct['proname']; ?>
                                </td>
                                <td>
                                    <?php echo $getproduct['inrmain']; ?>
                                </td>
                            <tr>
                                <th>
                                    Total Price;
                        ...
                        <div class="btn-group">
                            <a href="finalorder.php?withid=<?php echo $getproduct['id'];  ?>"
                                class="w-50 btn btn-success">ORDER NOW</a>
                            <a href="userhome.php?withid=<?php echo $getproduct['id'];?>"
